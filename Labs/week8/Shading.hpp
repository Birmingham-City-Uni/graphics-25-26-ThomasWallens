...
Eigen::Vector3f reflect(const Eigen::Vector3f& incoming, const Eigen::Vector3f& normal)
{
	...
	return incoming + (2 * fabs(normal.dot(incoming)) * normal);
	// *** END YOUR CODE ***
}
